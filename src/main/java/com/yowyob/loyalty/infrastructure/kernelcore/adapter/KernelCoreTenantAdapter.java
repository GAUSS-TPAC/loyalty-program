...
public class KernelCoreTenantAdapter {
    ...
    /**
     * Récupère l'organisation depuis Kernel Core, mappe en Tenant, met en cache.
     * Lève TenantNotFoundException si l'organisation n'existe pas ou n'est pas accessible.
     */
